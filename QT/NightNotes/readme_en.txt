...
+ the app supports Markdown format, so you can take your notes even easier (see quick markdown guide below)

The latest version of the app you can always find here:
[http://nightnotes.bykov.me](http://nightnotes.bykov.me)
